...
const char* password = "MEAi7_*tb:"; // Replace with your network password
#define DATABASE_URL "https://wk5-firebase-default-rtdb.firebaseio.com/" // Replace with your database URL
#define API_KEY "AIzaSyAJ7AVz6PYulcmRawshVyUHM2dmaC_arG0" // Replace with your API key
